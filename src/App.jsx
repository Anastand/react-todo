...
function App() {
  ...
  //   console.log("hrer from done");
  //   newtodoedited[index] = completedtodomodify;
  //   settodo_List(newtodoedited);
  //   savetodoappdata(newtodoedited);
  // }
  // the function above doesnt work and i dont know why 

  function handleEditTodo(index) {
    // this function was generated by ai and it works but i dont understand its working fully , needs work
    // Create a new array to maintain immutability
    const updatedTodos = todo_List.map((todo, i) => {
      if (i === index) {
        // Return a new object with updated complete property
        return { ...todo, complete: true };
      }
      return todo;
    });
    // Update state with the new array
    settodo_List(updatedTodos);
    // Save the updated data
    savetodoappdata(updatedTodos);
  }
